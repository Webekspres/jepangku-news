    ...
    <div className="bg-white min-h-screen" data-testid="submit-article-page">
      <section className="border-b-2 border-[#0A0A0A] bg-[#F4F4F5]">
        <div className="px-4 mx-auto max-w-7xl py-12">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#D90429] mb-2">NEW ARTICLE</p>
          <h1 className="font-heading font-black text-4xl tracking-tighter">Submit New Article</h1>
          <p className="text-[#52525B] mt-2">Bagikan cerita atau berita Jepang. Artikel akan direview admin sebelum tayang.</p>
        </div>
      </section>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-[#52525B] font-mono mt-2">
              Use HTML tags: &lt;p&gt;, &lt;h2&gt;, &lt;strong&gt;, &lt;em&gt;, &lt;ul&gt;&lt;li&gt;
            </p>
          </div>
