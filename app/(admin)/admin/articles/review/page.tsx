            ...
            <div className="space-y-2">
              ...
              {articles.map((article: any) => (
                <button
                  ...
                  className={`w-full text-left p-4 border transition-colors ${selected?.id === article.id ? "border-jepang-red bg-jepang-off-white" : "border-jepang-border hover:border-foreground"}`}
