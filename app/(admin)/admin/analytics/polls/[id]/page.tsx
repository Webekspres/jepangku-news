...
export default function PollAnalyticsPage() {
  ...
  return (
    ...
    >
      <AnalyticsNav extra={{ href: "#", label: "Detail Poll", icon: MessageSquare }} />
        ...
        <>
          <div className="grid grid-cols-2 gap-4 mb-8 max-w-md">
            ...
            <div className="border border-jepang-border p-4 text-center">
              ...
              <p className="font-mono font-black text-3xl mt-1 text-jepang-red">{data.uniqueVoters}</p>
            </div>
          </div>
          ...
          <div className="space-y-6 mb-6">
            {(data.questionStats || []).map((q: any) => (
              <div key={q.id} className="border border-jepang-border p-5">
                ...
                <p className="text-xs text-jepang-muted mb-4">{q.totalVotes} suara pada pertanyaan ini</p>
