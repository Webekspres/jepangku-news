...
const LMS_SECTION_CLASS =
  "overflow-hidden bg-jepang-navy bg-[url('/assets/images/bg-lms.webp')] bg-cover bg-center py-12 text-white";
...
export default function HomeLmsTeaser({ data, loading, error }: HomeLmsTeaserProps) {
  if (error) {
    return (
      <section className={LMS_SECTION_CLASS}>
  ...
  return (
    <section className={LMS_SECTION_CLASS} data-testid="home-lms-teaser">
      <div className="px-4 mx-auto max-w-7xl">
        ...
        {data.source === "placeholder" || data.courses.length === 0 ? (
          ...
          <div className="relative flex flex-col items-center gap-6 md:gap-8 lg:min-h-128 lg:block">
            ...
            <AssetImage
              ...
              alt="Maskot Sensei Jepangku"
              width={1090}
              height={1259}
              className="hidden h-auto shrink-0 object-contain lg:absolute lg:-bottom-40 lg:right-0 lg:block lg:w-96 xl:w-110"
            />
          </div>
        )}
      </div>
