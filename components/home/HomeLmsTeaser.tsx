    ...
    <section className="relative overflow-hidden py-12 bg-jepang-navy text-white" data-testid="home-lms-teaser">
      ...
      <div className="relative z-10 px-4 mx-auto max-w-7xl">
        ...
        {data.source === "placeholder" || data.courses.length === 0 ? (
          ...
          <div className="relative flex flex-col items-center gap-6 md:gap-8 lg:block">
            ...
            <AssetImage
              ...
              width={320}
              height={320}
              className="hidden shrink-0 object-cover object-top lg:absolute lg:bottom-0 lg:right-0 lg:block lg:w-110 lg:translate-y-40"
            />
          </div>
        )}
      </div>
