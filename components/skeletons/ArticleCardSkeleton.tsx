    ...
    <div className="block bg-white border border-jepang-border animate-pulse">
      ...
      <div className="p-5 space-y-3">
        <div className="flex gap-2">
          <div className="h-5 w-16 bg-jepang-red/10 animate-pulse" />
        </div>
        <div className="space-y-2">
          <div className="h-6 bg-jepang-red/10 animate-pulse w-full" />
          <div className="h-6 bg-jepang-red/10 animate-pulse w-4/5" />
        </div>
        <div className="h-4 bg-jepang-red/10 animate-pulse w-full" />
        <div className="h-4 bg-jepang-red/10 animate-pulse w-3/4" />
        <div className="pt-3 border-t border-jepang-border flex justify-between">
          <div className="h-3 bg-jepang-red/10 animate-pulse w-1/4" />
          <div className="h-3 bg-jepang-red/10 animate-pulse w-1/4" />
        </div>
      </div>
    </div>
