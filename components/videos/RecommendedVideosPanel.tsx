...
type RecommendedVideosPanelProps = {
...
export default function RecommendedVideosPanel({
  videos,
  loading = false,
  className,
  testIdPrefix = "video-sidebar-recommended",
}: RecommendedVideosPanelProps) {
  return (
    <aside
      className={cn(
    ...
    >
      <div className="mb-4 flex items-center justify-between gap-2 border-b border-jepang-border pb-3">
        <div className="flex items-center gap-2">
          ...
          />
          <h3 className="small-caps">テレビ / Video Lainnya</h3>
        </div>
        <Link
          href="/tv"
